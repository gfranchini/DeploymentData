...
class AccessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create access" do
    assert_difference('Access.count') do
      post accesses_url, params: { access: { access: @access.access, adminid: @access.adminid, contact: @access.contact, form_id: @access.form_id, passsword: @access.passsword } }
    end
  ...
  test "should update access" do
    patch access_url(@access), params: { access: { access: @access.access, adminid: @access.adminid, contact: @access.contact, form_id: @access.form_id, passsword: @access.passsword } }
